...
class _MovieViewState extends State<MovieView> {
  ...
  String getMovieType(String mediaType) {
    return mediaType == "tv" ? AppLocalizations.of(context)!.tvShow : mediaType == "movie" ? AppLocalizations.of(context)!.movie : AppLocalizations.of(context)!.series;
  }

  @override
  Widget build(BuildContext context) {
    String mediaOrigin = '${CountryEmoji().get(movie.originalLanguage)} ${getMovieType(movie.mediaType)}';
    String nbVotesSentence = "${movie.voteCount} ${AppLocalizations.of(context)!.votes}";
